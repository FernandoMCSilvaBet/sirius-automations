...
CT 01.03 - Tentar realizar cadastro de conta sem CPF válido
...
CT 01.04 - Tentar realizar cadastro de conta com CPF válido porem não disponível na receita
...
CT 01.05 - Tentar cadastrar com CPF de menor de idade
...
CT 01.07 - Tentar realizar cadastro de conta sem email válido
...
CT 01.08 - Tentar realizar cadastro de conta com email válido porem já cadastrado
...
CT 01.09 - Tentar realizar cadastro de conta sem Senha válida
...
CT 01.10 - Tentar realizar cadastro de conta sem Confirmação de Senha
...
CT 01.11 - Tentar realizar cadastro de conta sem Telefone válido
...
CT 01.12 - Tentar realizar cadastro de conta com Telefone válido já cadastrado
...
CT 01.15 - Validar "Faça o Login aqui" em Cadastro de conta
