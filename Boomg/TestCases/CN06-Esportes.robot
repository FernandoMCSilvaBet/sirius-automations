...
# CT 06.06 - Validar o botão Handebol superior
...
CT 06.12 - Validar o botão Ao Vivo lateral
...
CT 06.13 - Validar o botão TV lateral
...
CT 06.14 - Validar o botão Promoções lateral
...
CT 06.15 - Validar o botão Como Apostar lateral
...
# CT 06.16 - Validar o botão Futebol lateral
...
# CT 06.17 - Validar o botão "Tudo em Futebol" lateral
...
# CT 06.18 - Validar o botão "Internacional" lateral
...
# CT 06.19 - Validar o botão "Internacional-Futebol" lateral
...
# CT 06.20 - Validar o botão "Brasil" lateral
...
# CT 06.21 - Validar o botão "Brasil-Futebol" lateral
...
# CT 06.22 - Validar o botão Tênis de Mesa lateral
...
# CT 06.23 - Validar o botão Tênis lateral (HOJEFORA)
...
# CT 06.24 - Validar o botão Voleibol lateral (HOJEFORA)
...
# CT 06.25 - Validar o botão Handebol lateral
...
# CT 06.26 - Validar o botão Hóquei lateral
...
# CT 06.27 - Validar o botão Rugby lateral
...
# CT 06.28 - Validar o botão Futsal lateral
...
# CT 06.29 - Validar o botão Basquete lateral
...
# CT 06.30 - Validar o botão Baseball lateral
...
# CT 06.31 - Validar o botão Resultados lateral
...
# CT 06.32 - Validar o botão Futebol central
...
# CT 06.33 - Validar o botão Tênis de Mesa central
...
# CT 06.34 - Validar o botão Futsal central
...
# CT 06.35 - Validar o botão Voleibol central
...
# CT 06.36 - Validar o botão Handebol central
...
# CT 06.37 - Validar o botão Hóquei central
...
# CT 06.38 - Validar o botão Rugby central
...
# CT 06.39 - Validar o botão Basquete central
...
# CT 06.40 - Validar o botão Baseball central
...
# CT 06.41 - Validar o botão "Escolher País" do "Filtre o evento desejado por país e competição" do Futebol
...
# CT 06.42 - Validar o botão "Escolher Campeonato" do "Filtre o evento desejado por país e competição" do Futebol
...
# CT 06.43 - Validar o botão "Limpar" do "Filtre o evento desejado por país e competição" do Futebol
#     [Documentation]     Teste valida o botão "Escolher Campeonato"
#     [Tags]    Esportes    Funcional
#     Dado que acesso o Menu ESPORTES 
#     E acesso o Menu Futebol
...
# CT 06.44 - Validar o botão "Ao Vivo" do Futebol
...
# CT 06.45 - Validar o botão "Ainda Hoje" do Futebol
...
# CT 06.46 - Validar o botão "Amanhã" do Futebol
#     [Documentation]     Teste valida o botão "Ainda Hoje" do Futebol
#     Dado que acesso o Menu ESPORTES
#     E acesso o Menu Futebol 
...
# CT 06.47 - Validar o botão "Próximos Dias" do Futebol
#     [Documentation]     Teste valida o botão "Ainda Hoje" do Futebol
#     Dado que acesso o Menu ESPORTES
#     E acesso o Menu Futebol 
...
# CT 06.48 - Validar o botão "Todos" do Futebol
...
# CT 06.49 - Validar o botão "+" do Esporte
...
# CT 06.50 - Validar o botão "Resultados" do Esporte
...
# CT 06.51 - Validar o botão "Handicap" do Esporte
...
# CT 06.52 - Validar o botão "Gols" do Esporte
#     [Documentation]     Teste valida o botão "Handicap"
#     [Tags]    Esportes    Funcional
#     Dado que acesso o Menu ESPORTES       
#     Quando clico no botão Futebol lateral
...
# CT 06.53 - Validar o botão "Múltiplos" do Esporte
