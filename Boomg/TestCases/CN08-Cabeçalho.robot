...
*** Test Cases ***
CT 08.01 - Validar o botão Cadastre-se agora!
    [Documentation]     Teste valida o botão Cadastre-se agora!
    [Tags]    Cabeçalho    Funcional        
    Dado que clico no botão Cadastre-se agora
    Então entro no botão Cadastre-se agora

CT 08.02 - Validar o botão x
    [Documentation]     Teste valida o botão x do Cadastre-se agora!
    [Tags]    Cabeçalho    Funcional        
    Dado que clico no botão Cadastre-se agora
    Então entro no botão Cadastre-se agora

CT 08.03 - Validar o botão Faça seu primeiro depósito!
    [Documentation]     Teste valida o botão Faça seu primeiro depósito!
    [Tags]    Cabeçalho    Funcional
...
CT 08.04 - Validar o botão Início
    [Documentation]     Teste valida o botão Início
    [Tags]    Cabeçalho    Funcional        
    Dado que clico no botão Início
    Então entro no botão Início

CT 08.05 - Validar o botão Cassino
...
CT 08.06 - Validar o botão Cassino Ao Vivo
...
CT 08.07 - Validar o botão Esportes
...
CT 08.08 - Validar o botão Pesquisar
...
CT 08.09 - Validar o botão Suporte
...
CT 08.10 - Validar o botão Promoções
...
CT 08.15 - Validar o botão Depositar
...
CT 08.16 - Validar o botão Minha Conta
...
CT 08.17 - Validar o botão Sair da conta
...
CT 08.18 - Validar o botão que atualiza o saldo
